...
const Footer = () => {
  const [redirect_links, setredirect_links]: any = useState({})
  useEffect(() => {
    const getData = async () => {
      ...
      <footer className="p-4  sm:p-6 bg-[#182f38]">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className=" ">
                <li className="mb-4">
                  <a href={redirect_links.sponsor} target="_blank" rel="noreferrer" className="hover:underline">
                    Become a sponsor
                  </a>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href={redirect_links.facebook_group} target="_blank" rel="noreferrer">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <a href={redirect_links.instagram} target="_blank" rel="noreferrer">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
